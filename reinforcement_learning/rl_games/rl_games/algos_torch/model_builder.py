...
from rl_games.algos_torch import transformer_builder
...
class NetworkBuilder:
    def __init__(self):
        ...
        self.network_factory.register_builder('transformer', lambda **kwargs: transformer_builder.TransformerBuilder())
        self.network_factory.register_builder('transformer_shared', lambda **kwargs: transformer_builder.TransformerBuilder())
        self.network_factory.register_builder('body_transformer', lambda **kwargs: transformer_builder.TransformerBuilder())
        self.network_factory.register_builder('body_transformer_shared', lambda **kwargs: transformer_builder.TransformerBuilder())
        self.network_factory.register_builder('mlp', lambda **kwargs: transformer_builder.TransformerBuilder())

...
class A2CBuilder(NetworkBuilder):
    ...
    class Network(NetworkBuilder.BaseNetwork):
        def __init__(self, params, **kwargs):
            ...
            actor_nparams = sum(p.numel() for p in self.actor_mlp.parameters())
            value_nparams = sum(p.numel() for p in self.value.parameters())
            critic_nparams = sum(p.numel() for p in self.critic_mlp.parameters())
            print('actor params:', actor_nparams)
            print('value params:', value_nparams)
            print('critic params:', critic_nparams)
            print('total params:', actor_nparams + value_nparams + critic_nparams)

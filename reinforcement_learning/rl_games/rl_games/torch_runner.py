...
def _restore(agent, args):
    ...
    elif 'copy' in args and args['copy'] is not None:
        agent.restore_from_copy(args['copy'])
...
class Runner:
    ...
    def continue_play(self, player, args):
    ...
    def run(self, args):
        ...
        if args['train']:
            ...
            player = self.run_play(args)
        elif args['cont']:
            player = self.continue_play(player, args)
        else:
            self.run_train(args)